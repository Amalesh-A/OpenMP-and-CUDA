...
void HyperCube_Class::check_list() {
    int tag = 0;
    int min_nbr = 268435456;		// Assumes list contains non-negative integers; 6-21-2017
...
void HyperCube_Class::HyperCube_QuickSort() {
    ...
    //perform a sum reduction across all processes in the sub_hypercube_comm communicator to calculate the total 
    //sum of the local_median values from each process and store the result in pivot.
	...
	if (nbr_k > my_id) {
        ...
        //sends the integer value in list_size_leq to the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag of 
        //0.
        ...
        //receives a single integer value from the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag of 0, and 
        //stores the received value in the variable nbr_list_size.
        ...
        //sends list_size_leq number of integer values from the list array starting at index idx to the process with rank nbr_k in the 
        //default communicator MPI_COMM_WORLD using a tag of 0.
        ...
        //receives nbr_list_size number of integer values from the process with rank nbr_k in the default communicator MPI_COMM_WORLD using
        //a tag of 0, and stores the received values in the nbr_list array.
        ...
        //sends the integer value in list_size_gt to the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag of 0.
        ...
        //receives nbr_list_size number of integer values from the process with rank nbr_k in the default communicator MPI_COMM_WORLD using 
        //a tag of 0, and stores the received values in the array nbr_list.
		MPI_Recv(nbr_list, nbr_list_size, MPI_INT, nbr_k, 0, MPI_COMM_WORLD, &status);
        ...
        //sends list_size_gt number of integer values from the list array starting at index 0 to the process with rank nbr_k in the default 
        //communicator MPI_COMM_WORLD using a tag of 0.
