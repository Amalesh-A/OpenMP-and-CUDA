...
void HyperCube_Class::HyperCube_QuickSort() {
	...
	// ***** Add MPI call here *****
	//MPI_Allreduce performs a reduction operation (like sum, max, etc) across all the processes in a communicator and distributes the result back to all processes.
	//calculate the sum of local median values from each process, and storing the total sum into pivot
	...
	if (nbr_k > my_id) {
		...
		//sends the integer value in the variable list_size_gt to the process with rank nbr_k in the default communicator MPI_COMM_WORLD 
		//using a tag value of 0.
		...
		//receives an integer value from the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag value of 0, 
		//and stores the received value in the variable nbr_list_size
		...
		//sends an array of integer values from the variable list starting at index idx, and sends list_size_gt number 
		//of elements to the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag value of 0.
		...
		//This MPI statement receives an array of integer values from the process with rank nbr_k in the default communicator MPI_COMM_WORLD
		// using a tag value of 0. It will receive nbr_list_size number of elements and store them in the array nbr_list. The status object 
		//contains information about the received message.
		MPI_Recv(nbr_list, nbr_list_size, MPI_INT, nbr_k, 0, MPI_COMM_WORLD, &status);
		...
		//This MPI statement receives a single integer value from the process with rank nbr_k in the default communicator MPI_COMM_WORLD 
		//using a tag value of 0, and stores the received integer value in the variable nbr_list_size. The status object contains information
		...
		//This MPI statement sends the integer value in the variable list_size_leq to the process with rank nbr_k in the default communicator 
		//MPI_COMM_WORLD using a tag value of 0.
		...
		//This MPI statement sends an array of integer values from the variable list starting at index 0, and sends list_size_leq number of 
		//elements to the process with rank nbr_k in the default communicator MPI_COMM_WORLD using a tag value of 0.
